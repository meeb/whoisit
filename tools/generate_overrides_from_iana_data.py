...
Usage:
    uv run tools/generate_overrides_from_iana_data.py > whoisit/overrides.py.tmp && mv whoisit/overrides.py.tmp whoisit/overrides.py
"""
...
if __name__ == "__main__":
    ...
    print(OVERRIDES_TEMPLATE.format(overrides=overrides_str, updated=updated))
    log.info("Done")
